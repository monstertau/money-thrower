...
@Component({
    selector: 'app-wallet-add-icon',
    templateUrl: './wallet-add-icon.component.html',
    styleUrls: ['./wallet-add-icon.component.css']
})
export class WalletAddIconComponent implements OnInit {
